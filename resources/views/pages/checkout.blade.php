          ...
          <div class="card card-details">
              ...
              <table class="table table-responsive-sm text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">{{ \Carbon\Carbon::createFromDate($detail->deo_passport) > \Carbon\Carbon::now() ? 'Active' : 'Inactive' }}</td>
                    <td class="align-middle">
            ...
            <div class="member mt-3">
              ...
              <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                ...
                <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" style="width:50px;" placeholder="Nationality">
